...
getSMIPSTimeSeries(product='Openloop_Wetness_Index', startDate='01-10-2010', endDate='25-11-2015', longitude=153.0219, latitude=-27.4374 )
...
dt='15-06-2018'
r <- getSMIPSrasterCSIRO_OpenDAP(dt=dt, resFactor=100)
plot(r)
